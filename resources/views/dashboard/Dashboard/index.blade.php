...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    <div class="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-5 rounded-xl shadow hover:scale-105 transition-transform duration-300">
    ...
    <div class="bg-gradient-to-r from-green-400 to-emerald-600 text-white p-5 rounded-xl shadow hover:scale-105 transition-transform duration-300">
        <div class="flex justify-between items-center">
            <div>
    ...
    <div class="bg-gradient-to-r from-yellow-400 to-orange-500 text-white p-5 rounded-xl shadow hover:scale-105 transition-transform duration-300">
        <div class="flex justify-between items-center">
            <div>
    ...
    <div class="bg-gradient-to-r from-pink-500 to-rose-600 text-white p-5 rounded-xl shadow hover:scale-105 transition-transform duration-300">
        <div class="flex justify-between items-center">
            <div>
